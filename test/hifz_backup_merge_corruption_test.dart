...
void main() {
  ...
  test('malformed local Hifz history cannot block a valid incoming restore', () async {
  ...
  test('malformed incoming Hifz progress does not crash merge restore', () async {
    SharedPreferences.setMockInitialValues({
    ...
    final prefs = await SharedPreferences.getInstance();
    expect(prefs.getString('memorization_page_progress_v1'), '{broken-json');
  });
}
