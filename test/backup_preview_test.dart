...
void main() {
  ...
  test('previews current compatible backup without mutating data', () {
    final preview = parser.parse(<String, Object?>{
      ...
      'data': <String, Object?>{
        'notes': <String, Object?>{'verse_notes': '{}', 'verse_note_sources': '{}'},
  ...
  test('keeps versions one through three restorable', () {
    for (final version in <int>[1, 2, 3]) {
      final preview = parser.parse(<String, Object?>{'version': version, 'createdAt': '2026-09-16T06:00:00Z', 'data': <String, Object?>{}});
      expect(preview.canRestore, isTrue, reason: 'version $version');
    }
  });

  test('blocks unsupported backup versions', () {
    final preview = parser.parse(<String, Object?>{'version': 99, 'createdAt': '2026-09-16T06:00:00Z', 'data': <String, Object?>{}});
  ...
  test('reports malformed metadata and payload', () {
    final preview = parser.parse(<String, Object?>{'version': 4, 'createdAt': 'not-a-date', 'data': <String, Object?>{'notes': 'invalid'}});
    expect(preview.canRestore, isFalse);
  ...
  test('rejects section list shape before restore can start', () {
    final preview = parser.parse(<String, Object?>{
      'version': 4,
      'createdAt': '2026-09-16T06:00:00Z',
      'data': <String, Object?>{'notes': <Object?>[1, 2]},
    });
    expect(preview.canRestore, isFalse);
    expect(preview.issues, contains(BackupPreviewIssue.invalidData));
  });
  ...
  test('rejects missing backup version metadata', () {
    final preview = parser.parse(<String, Object?>{'createdAt': '2026-09-16T06:00:00Z', 'data': <String, Object?>{}});
    expect(preview.canRestore, isFalse);
  ...
  test('normalizes offset backup timestamp to UTC', () {
    final preview = parser.parse(<String, Object?>{'version': 4, 'createdAt': '2026-09-16T14:00:00+08:00', 'data': <String, Object?>{}});
    expect(preview.canRestore, isTrue);
    expect(preview.createdAt, DateTime.utc(2026, 9, 16, 6));
  });
  ...
  test('reports invalid map keys without counting them', () {
    final preview = parser.parse(<String, Object?>{
      ...
      'createdAt': '2026-09-16T06:00:00Z',
      'data': <Object?, Object?>{
        'notes': <String, Object?>{'verse_notes': '{}'},
        42: <String, Object?>{'bad': true},
      },
    });
    expect(preview.canRestore, isFalse);
