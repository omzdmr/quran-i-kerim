...
void main() {
  ...
  test('backup preview reports qada events instead of one opaque preference', () {
    ...
    final preview = parser.parse(<String, Object?>{'version': BackupManifest.schemaVersion, 'createdAt': '2026-09-21T08:02:00Z', 'data': <String, Object?>{'fasting': <String, Object?>{QadaFastingStore.preferenceKey: ledger.encode()}}});
  ...
  test('malformed qada payload is visible as invalid before restore', () {
    final preview = parser.parse(<String, Object?>{'version': BackupManifest.schemaVersion, 'createdAt': '2026-09-21T08:02:00Z', 'data': <String, Object?>{'fasting': <String, Object?>{QadaFastingStore.preferenceKey: '{broken'}}});
  ...
  test('duplicate qada event ids are rejected in preview', () {
    const duplicate = '{"formatVersion":1,"entries":['
        ...
        ']}';
    final preview = parser.parse(<String, Object?>{'version': BackupManifest.schemaVersion, 'createdAt': '2026-09-21T08:02:00Z', 'data': <String, Object?>{'fasting': <String, Object?>{QadaFastingStore.preferenceKey: duplicate}}});
    expect(preview.canRestore, isFalse);
    expect(preview.issues, contains(BackupPreviewIssue.invalidData));
  });

  test('empty qada ledger reports zero worship-history events', () {
    final preview = parser.parse(<String, Object?>{'version': BackupManifest.schemaVersion, 'createdAt': '2026-09-21T08:02:00Z', 'data': <String, Object?>{'fasting': <String, Object?>{QadaFastingStore.preferenceKey: QadaFastingLedger().encode()}}});
    expect(preview.recordCounts['fasting'], 0);
  });
}
