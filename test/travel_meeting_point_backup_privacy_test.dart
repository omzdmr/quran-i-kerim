...
void main() {
  test('private travel tools are not captured by automatic backup', () async {
    ...
    await const TravelPackingStore().save(const [
      TravelPackingItem(id: 'private', label: 'Private item', packed: false),
    ]);
    ...
    expect(backup.containsKey(TravelPackingStore.storageKey), isFalse);
  });
}