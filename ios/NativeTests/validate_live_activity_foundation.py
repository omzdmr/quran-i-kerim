...
required_widget = ['ActivityConfiguration(for: PrayerActivityAttributes.self)','DynamicIsland {','PrayerLiveActivityWidget()','quranikerim://prayer','.privacySensitive()','context.isStale','isStale: context.isStale']
