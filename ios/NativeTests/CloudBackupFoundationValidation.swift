...
enum CloudBackupFoundationValidation {
  static func main() throws {
    ...
    precondition(try staged.resourceValues(forKeys: [.isExcludedFromBackupKey]).isExcludedFromBackup == true)
    ...
    precondition(try String(contentsOf: destination) == "first")
    ...
    precondition(try String(contentsOf: destination) == "second")
