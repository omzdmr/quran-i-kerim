...
required = ['app.quranikerim/native_keyboard','guard keyboardBridgeEnabled else { return super.keyCommands }','case "setEnabled"','var commands: [UIKeyCommand] = super.keyCommands ?? []','UIKeyCommand(input: "f", modifierFlags: .command','for index in 1...5','"action": "search"','"action": "selectTab"','"index": number - 1']
