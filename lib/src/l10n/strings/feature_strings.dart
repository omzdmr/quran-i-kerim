const featureStrings = <String, Map<String, String>>{
  ...
  'fr': <String, String>{
    ...
    'readerAppearanceMenuSubtitle':
        'Taille du texte et interligne partagés',
    ...
    'relaxed': 'Aéré',
    'readerSizeHint':
        'La taille du texte est indépendante de la source sélectionnée et reste identique lorsque vous changez de traduction.',
    ...
    'searchHintBody':
        'Exemples : « Baqara », « 2:255 » ou « patience ». La recherche utilise la traduction hors ligne sélectionnée.',
    'surahs': 'Sourates',
    ...
    'enlarge': 'Agrandir',
    'translationPackError':
        'Le pack de traduction sélectionné n’a pas pu être ouvert. Le texte arabe reste disponible.',
    ...
    'translationUnavailableYet':
        'Aucun pack de téléchargement vérifié n’est encore prêt pour cette traduction.',
    'deleteDownload': 'Supprimer le téléchargement',
    'deleteDownloadConfirm': 'Supprimer la traduction téléchargée ?',
    'deleteDownloadBody':
        'La traduction sera supprimée de cet appareil et pourra être téléchargée à nouveau plus tard.',
    'delete': 'Supprimer',
    ...
    'worldCitySearchInfo':
        'Les villes du monde sont recherchées hors ligne. Si nécessaire, utilisez le GPS ou une recherche en ligne explicite.',
    'cityNotFoundBody':
        'Si votre ville manque, laissez-nous trouver votre position avec le GPS ou lancez une recherche en ligne ponctuelle.',
    ...
    'locationDataAttribution':
        'Données de villes hors ligne : GeoNames (CC BY 4.0) · Recherche en ligne : contributeurs OpenStreetMap',
    'qiblaLocationPrompt': 'La position est nécessaire pour la Qibla',
    'qiblaLocationPromptBody':
        'Autorisez l’accès à la position et nous calculerons la direction de la Kaaba depuis votre emplacement exact. Aucun choix de ville n’est nécessaire.',
    ...
    'isha': 'Isha',
    'prayerOfflineInfo':
        'Les horaires de prière sont calculés sur l’appareil et ne nécessitent pas Internet chaque jour. La méthode et les ajustements en minutes peuvent être modifiés dans les réglages.',
    'qiblaNorthDescription': 'Direction de la Qibla depuis le nord',
    'qiblaCalibrationInfo':
        'Gardez le téléphone à plat. Si la précision de la boussole est faible, calibrez-la en déplaçant l’appareil en forme de huit. Les coques magnétiques, les surfaces métalliques et les appareils électroniques peuvent perturber la boussole.',
    'calculationMethod': 'Méthode de calcul',
    'calculationMethodInfo':
        'Le mode automatique utilise la méthode recommandée pour la ville sélectionnée.',
    ...
    'highLatitudeInfo':
        'Utilisé pour le Fajr et l’Isha pendant les journées d’été ou d’hiver très longues.',
    'rule': 'Règle',
    'minuteAdjustments': 'Ajustements en minutes',
    'minuteAdjustmentsInfo':
        'Si un calendrier local diffère légèrement, ajustez chaque prière de -30 à +30 minutes.',
    'prayerSettingsInfo':
        'Les réglages sont enregistrés sur cet appareil. Si votre calendrier officiel local diffère, modifiez la méthode ou l’ajustement en minutes.',
    ...
    'locationPermissionDenied':
        'L’autorisation de localisation n’a pas été accordée. Vous pouvez continuer en choisissant une ville.',
    'locationServicesDisabled':
        'Les services de localisation sont désactivés.',
    'locationFailed':
        'Impossible d’obtenir votre position. Vous pouvez continuer en choisissant une ville.',
    'gpsSource': 'Position GPS',
    'liveQibla': 'Direction de la Qibla en direct',
    'compassUnavailable':
        'Les données de boussole en direct sont indisponibles ; l’angle de la Qibla par rapport au nord est affiché.',
    'qiblaAligned': 'Vous êtes orienté vers la Qibla',
    'prayerNotifications': 'Notifications de prière',
    'prayerNotificationsInfo':
        'Des notifications locales sont programmées sur cet appareil pour les prières que vous sélectionnez.',
    ...
    'hijriDateOffsetInfo':
        'Si votre calendrier local fondé sur l’observation lunaire diffère, ajustez la date hégirienne de -2 à +2 jours.',
    'daysUnit': 'jours',
  },
};
