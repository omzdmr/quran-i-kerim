const homeVerseStrings = <String, Map<String, String>>{
  'tr': <String, String>{
    'homeVerseExpand': 'Ayeti genişlet',
  ...
  'ar': <String, String>{
    'homeVerseExpand': 'عرض الآية كاملة',
    ...
    'homeCommunityHighlight': 'ميزت آية',
    'homeCommunityNote': 'أضفت ملاحظة إلى آية',
  },
  'az': <String, String>{
    'homeVerseExpand': 'Ayəni genişləndir',
  ...
  'ru': <String, String>{
    'homeVerseExpand': 'Развернуть аят',
