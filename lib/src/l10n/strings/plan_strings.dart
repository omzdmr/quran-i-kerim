const planStrings = <String, Map<String, String>>{
  'tr': <String, String>{
    ...
    'plansArchiveDeleteBodyV1': 'Bu tamamlanma kaydı arşivden silinecek ve yıllık sayım güncellenecek.',
  ...
  'en': <String, String>{
    ...
    'plansArchiveNoResultsV1': 'There are no completed khatm records for this year.',
  ...
  'ar': <String, String>{
    ...
    'plansArchiveDeleteBodyV1': 'سيُحذف سجل الإكمال من الأرشيف وسيتم تحديث مجموع السنة.',
  ...
  'az': <String, String>{
    ...
    'plansArchiveDeleteBodyV1': 'Bu tamamlanma qeydi arxivdən silinəcək və illik say yenilənəcək.',
