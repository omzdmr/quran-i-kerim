...
Future<void> showPrayerNotificationDiagnosticsSheet({
  ...
  builder: (_) => PrayerNotificationDiagnosticsSheet(
    notificationsEnabled: notificationsEnabled,
  ),
);

class PrayerNotificationDiagnosticsSheet extends StatefulWidget {
  const PrayerNotificationDiagnosticsSheet({
  ...
  @override
  State<PrayerNotificationDiagnosticsSheet> createState() =>
      _PrayerNotificationDiagnosticsSheetState();
}

class _PrayerNotificationDiagnosticsSheetState
    extends State<PrayerNotificationDiagnosticsSheet> {
          ...
          children: [
            ...
            if (_error != null) ...[
              ...
              _DiagnosticRow(
                ...
                value: diagnostics.systemPermissionGranted == null
              ...
              _DiagnosticRow(
                ...
                value: diagnostics.exactAlarmAvailable == null
              ...
              const PrayerNotificationSelfTestButton(),
            ],
          ],
        ),
      ),
